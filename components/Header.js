...
const Header = () => {
    ...
    return (
        <div className="flex justify-between px-7 py-3 w-full items-center  bg-white md:px-10 relative">
            <div className="flex justify-center items-center gap-3">
            <svg onClick={()=>setShow(!show)} className=" md:hidden "  fill="#000000" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px"><path d="M 2 5 L 2 7 L 22 7 L 22 5 L 2 5 z M 2 11 L 2 13 L 22 13 L 22 11 L 2 11 z M 2 17 L 2 19 L 22 19 L 22 17 L 2 17 z"/></svg>
               <div className="flex items-center gap-4 md:flex-col md:gap-1">
               <svg className="w-16 md:w-auto" width="99" height="56" viewBox="0 0 99 56" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop offset="1" stop-color="#F15A24"/>
          ...
          <h3 className="text-textDark font-normal text-md">GrowwTen</h3>
          </div>
            </div>
            <div className="flex gap-7 items-center ">
                    ...
                    <div className="flex  gap-3 text-sm">
                       <button className="login py-2 px-5 bg-secondary rounded-sm text-white">Login</button>
